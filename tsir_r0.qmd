...
### After filter pixel > 1000 people/km2
...
#### District-specific Rt and HIT of HFMD in HCMC.
...
#### Heatmap and dendrogram of beta
...
#| fig-height: 8
#| out-width: "100%"
#| fig-cap: Heatmap of bi-weekly beta by district. The dendrogram on the left side was the result of the clustering analysis
...
#| fig-height: 8
#| out-width: "100%"
#| fig-cap: Heatmap of bi-weekly rt by district. The dendrogram on the left side was the result of the clustering analysis
