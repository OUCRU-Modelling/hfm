...
hm <- ggplot(data=wwww$wdat, aes(x=date, y=age)) +
      ...
      geom_line(data = ch,aes(x = date,y = c2),col = "white",
                group = 1,lwd = 0.25,alpha = 0.8)+
      geom_line(data = ch,aes(x = date,y = c3),col = "black",
                group = 1,lwd = 0.25,alpha = 0.8)+
      geom_line(data = ch,aes(x = date,y = c4),col = "black",
                group = 1,lwd = 0.25,alpha = 0.8)+
      geom_line(data = ch,aes(x = date,y = c5),col = "black",
                group = 1,lwd = 0.25,alpha = 0.8)+
...
atk_rate <- df23 %>%
  ...
  coord_cartesian(ylim = c(-2.5,7.5),xlim = as.Date(c("2022-12-01","2023-12-31")))+
  theme_bw()+
  labs(x = "Admission week",y= "Log attack rate",tag = "A")+ 
