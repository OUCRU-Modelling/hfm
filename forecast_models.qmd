...
For BART model predict number of admission 1 week ahead $n_{t+1}$: admission week, number of admission at time $n_t$.

For BART model predict number of admission 2 weeks ahead $(n_{t+1},n_{t+2})$: admission week, $n_t,n_{t-1}$.

For BART model predict number of admission 3 weeks ahead $(n_{t+1},n_{t+2},n_{t+3})$: admission week, $n_t,n_{t-1},n_{t-2}$.

For BART model predict number of admission 4 weeks ahead $(n_{t+1},n_{t+2},n_{t+3},n_{t+4})$: admission week, $n_t,n_{t-1},n_{t-2},n_{t-3}$.
